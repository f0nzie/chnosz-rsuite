...
The goal of chnosz-rsuite is to provide a reproducible R platform for building the CHNOSZ vignettes. This comes in handy when new packages are released or a new version of R available and the applications do not run due to dependencies.
...
From the terminal, in the folder `chnosz-rsuite`, run the following command:
